...
import client.finam.component.JwtTokenStore;
import client.finam.dto.AuthResponseDTO;
...
public class AuthService {
    ...
    private static final String SECRET_KEY_PROPERTY_NAME = "secret.finam.key";

    /**
     * Получение JWT-токена методом POST-запроса к внешнему API.
     *
     * @param secretKey Секретный ключ для формирования тела запроса
     * @return Монадический объект AuthResponseDTO с результатом авторизации (токеном и датой).
     */
